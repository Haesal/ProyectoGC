...
* Perro de Origami: Lo que planeamos que haga el perro es que se comporte como si lo hubieras acariciado (mover la cola y las orejas, incline la cabeza y voltear a verte) y despues de 7 segundos regrese a su pose normal. (En este caso como aun no sabemos muy bien el proceso de animación, esto puede cambiar a algo más)
